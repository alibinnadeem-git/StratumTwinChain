...
const REPRESENTATIVE_FAMILY_DEFAULTS:Record<string,Partial<ElectricalModelConfig>>={
 ...
 'power-distribution-unit':representative('/models/equipment/uninterruptible-power-supply.glb',[.8,1.8,.75],'Representative floor-standing PDU envelope; replace with approved PDU submittal','Detailed power-distribution cabinet family visualization; breaker and transformer internals remain project-specific.','GLB'),
 ...
 'circuit-breaker':representative('/models/equipment/breaker-enclosure-representative.gltf',[.4,.65,.2],'Representative circuit-breaker enclosure; breaker frame and mounting remain project data','Detailed circuit-breaker enclosure family visualization.'),
