...
export const ELECTRICAL_COMPONENTS:ElectricalComponent[]=[
 ...
 {key:'evse-tesla-supercharger-v3',name:'Tesla Supercharger V3',category:'Renewable & EV Infrastructure',aliases:['tesla supercharger v3','tesla supercharger','tesla charger','supercharger'],twinShape:'evse',trackAsAsset:true,manufacturer:'Tesla',modelFamily:'Supercharger V3'},
