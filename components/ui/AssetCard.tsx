...
export default function AssetCard({asset}:{asset:Asset}){
 ...
 return <article className="shared-asset-card" data-asset-id={asset.id}>
  ...
  <div className="shared-asset-trust"><StatusChip domain="trust" state={asset.block?'DIR_RECORDED':'UNVERIFIED'} label={asset.block?`DIR ${asset.block} recorded`:'DIR pending'}/></div>
