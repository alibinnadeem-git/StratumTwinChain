...
const groups=[
 {label:'Workspace',links:[['/','Overview'],['/compiler','Twin Compiler'],['/twin','STRATUM Twin'],['/reality','Reality Reconciliation'],['/projects','Projects'],['/sites','Sites'],['/assets','Asset Passports']]},
 ...
 {label:'Trust',links:[['/handover','Digital Handover'],['/provenance','Provenance'],['/verify','Verify Record'],['/dirs','DIRS Explorer']]},
...
export default function Shell({children}:{children:ReactNode}){
 return <div className="shell">
  <aside className="sidebar">
   <div className="sidebar-head"><Link href="/" className="brand">STRATUM <span>VERIFIED</span></Link><div className="network-pill"><i/> DIRS · {process.env.STRATUM_CHAIN_ID||'stratum-devnet-1'}</div></div>
