...
const checks=[
  ...
  ['archive is append-only',route.includes('INSERT INTO asset_archive_events')&&route.includes("'ARCHIVE'")],
  ['restore is append-only',route.includes('INSERT INTO asset_archive_events')&&route.includes("'RESTORE'")],
