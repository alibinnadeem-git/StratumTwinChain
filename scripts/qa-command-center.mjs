...
const checks=[
 ...
 ['home page has an explicit unavailable-backend reference mode',page.includes('REFERENCE_UNAVAILABLE')&&page.includes('Live tenant data unavailable — reference data shown')],
 ...
 ['live empty tenant remains empty rather than substituting reference assets',page.includes('No active STRATUM Assets')&&page.includes('remains empty rather than substituting reference equipment')],
...
console.log('\nCommand-center tenant/reference truth-boundary contract passed.');
