...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "peer-alert-delivery-status is read-only. peer-alert-delivery-prune bounds only non-authoritative delivery receipts and does not prune alerts, acknowledgements, quarantine/evidence, trusted heads, or DIR/PFC history.")
