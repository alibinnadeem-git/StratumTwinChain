...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "commands: init, doctor, init-consensus-safety, verify-consensus-safety, verify-genesis, verify-genesis-trust, verify-snapshot, verify-finality, verify-validator-governance, verify-round-change, verify-plc, verify-proposer, verify-peer-envelope, serve-readonly-peer, serve-readonly-peer-sync, serve-readonly-peer-sync-governed, peer-probe, peer-sync, peer-sync-governed, peer-sync-survey, peer-sync-resolve, peer-sync-follow, peer-follower-status, peer-state-health, peer-state-diagnostic-export, peer-state-diagnostic-export-v2, peer-state-diagnostic-verify, peer-state-diagnostic-compare, peer-state-diagnostic-attest, peer-state-diagnostic-attestation-verify, peer-quarantine-status, peer-quarantine-release, peer-reliability-status, peer-alert-status, peer-alert-ack, peer-alert-deliver-webhook, peer-alert-delivery-status, peer-alert-delivery-prune, peer-alert-delivery-state-prune, peer-proof-cache-status, peer-proof-cache-prune, peer-service-package-systemd, peer-service-package-launchd, peer-service-package-windows-task, verify-peer-ancestry, verify-package, version")
