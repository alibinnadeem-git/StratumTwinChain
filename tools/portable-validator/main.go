...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "Peer follower status, alerts, quarantine, and reliability are local operational metadata only; they do not alter PoVI membership, governance, consensus weighting, or vote authority.")
}
