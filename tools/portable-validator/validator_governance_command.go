...
func verifyValidatorGovernanceCommand(args []string) error {
	...
	var proof ValidatorSetChangeProof;if err:=readJSON(*proofPath,&proof);err!=nil{return err}
	verified,err:=verifyValidatorSetChangeProof(proof,cfg.ChainID,strings.ToLower(*policyHash),strings.ToLower(*previousRoot));if err!=nil{return err}
