...
export default function ComponentLibraryPage(){
 return <div className={styles.page}>
  ...
  <div className={styles.notice}>Each class carries recognition aliases, a dedicated procedural 3D fallback, whether it should normally become a durable STRATUM Asset identity, and an optional detailed GLB/GLTF/OpenUSD model mapping for production-grade Spatial visualization.</div>
