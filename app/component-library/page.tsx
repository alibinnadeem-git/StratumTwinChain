...
export default function ComponentLibraryPage(){
 return <Shell><div className={styles.page}>
  ...
  <div className={styles.notice}>Each class carries recognition aliases, a dedicated 3D primitive fallback, whether it should normally become a durable STRATUM Asset identity, and now an optional detailed GLB/GLTF/OpenUSD model mapping for production-grade visualization.</div>
