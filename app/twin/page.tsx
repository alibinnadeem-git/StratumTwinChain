...
export default async function TwinPage(){
  ...
  try{
    ...
    backendOnline=false;
    console.error('STRATUM Twin backend data unavailable; rendering resilient twin workspace.',error);
  }
  ...
  return <>
    ...
    {!backendOnline&&<div className="card" style={{marginBottom:16,borderColor:'#75592e'}}><div className="eyebrow">Twin workspace online · backend reconnecting</div><p className="subtitle" style={{marginTop:6}}>The 3D Twin remains fully usable for viewing and design submission. Live STRATUM Verified asset records will appear automatically when the production database connection is available.</p></div>}
