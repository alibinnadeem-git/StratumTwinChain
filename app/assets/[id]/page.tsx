...
export default async function AssetDetail({params}:{params:Promise<{id:string}>}){
 ...
 let asset:any=null,events:any[]=[];let evidence:any[]=[];let archiveEvents:any[]=[];let backendOnline=true;
 try{
 ...
 return <>
 {!backendOnline&&<div className="card" style={{marginBottom:16,borderColor:'#75592e'}}><div className="eyebrow">LIVE BACKEND UNAVAILABLE</div><p className="subtitle" style={{marginTop:6}}>No reference asset was substituted. Retry after the tenant data connection is available.</p></div>}
